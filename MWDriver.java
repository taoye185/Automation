...
//	WebElementWait wew = new WebElementWait();
	...
	public MWDriver (DesiredCapabilities capabilities) throws IOException {
 ...
 * */	
		...
		and = new MWAndroidDriver<MobileElement>(new URL("http://127.0.0.1:4723/wd/hub"), capabilities);
		customizedCSVReader cr = new customizedCSVReader("");
 ...
 */
		...
		log.logConsole("The method \"" +parameters[2] + "("  + ")\" are called");
			...
			case "test": {this.test(driverType, parameters[5], parameters[6], parameters[7]);break;}
			...
			default: {
				if (driverType.equals("Android")) {
					switch (parameters[0]) {
						...
						case "clickNext": {and.clickNext(waitSec);break;}		
						case "enterEmptyPIN": {and.enterEmptyPIN(waitSec);break;}
...
//					this.nothing();
	...
	public WebElement findByURI(String driverName, String URI) {
		WebElement element;
		switch (driverName) {
		case "Android": {
	...
	public Object chooseDriver (String driverName) {
		switch(driverName) {
		case "Android": {
			return and; 
		}
	...
	public DesiredCapabilities chooseCap (String driverName) {
		switch(driverName) {
		case "Android": {
	...
	public DesiredCapabilities choosePage (String driverName) {
		switch(driverName) {
		case "Android": {
	...
	public void clickButton(String driverName, String URI) {
		try {
	...
	public void inputText(String driverName, String URI, String value) {
		try {
	...
	public void setBooleanValue(String driverName, String URI, String value) {

		try {
			if (this.findByURI(driverName, URI).getAttribute("checked")==value) {
				//do nothing
			}
			else {
				this.findByURI(driverName, URI).click();
	...
	public void launch(String driverName) throws InterruptedException {
	...
	public WebElement waitUntilElement (String driverName, int timeOutSec, String URI) {
		Object obj = this.chooseDriver(driverName);
		if (timeOutSec==0 ) {
			timeOutSec = 10;
		}
	...
	public String findCurrentPage (String driverName) throws InterruptedException {
//		Thread.sleep(500);
...
public String reachPageByProcess (String driverName, int timeoutIteration,String processName, String targetPage) throws InterruptedException {
...
public String waitUntilPage (String driverName, int timeout, String targetPage) throws InterruptedException {
...
public boolean test(String driverName, String method, String fieldName, String expectedValue) throws InterruptedException {
